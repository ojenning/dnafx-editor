...
#define DNAFX_LOOP_TIMEOUT	100000
...
void dnafx_send_interrupt(void) {
	...
	libusb_fill_bulk_transfer(ir, usb, DNAFX_ENDPOINT_IN, buffer, len, dnafx_usb_cb, GINT_TO_POINTER(DNAFX_TASK_INTERRUPT), 0);
